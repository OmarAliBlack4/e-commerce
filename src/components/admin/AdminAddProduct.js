...
const AdminAddProduct = () => {
    ...
    const [images , setImages, setName,name,description,setDescription,discount,setDiscount,price,setPrice,quantity,setQuantity,onSelectCategory,allCategory,options,onSelect,onRemove,onSelectBrand,allBrand,colors,handelDeleteColor,handelOpenColor,showColor,handelComplete,handelSubmt] = AddProductHook();
        ...
        <div>
            ...
            <Row>
                <Col sm="8" className="d-flex justify-content-end ">
                    <button onClick={handelSubmt} className="btn-save d-inline mt-2 ">Add Product </button>
                </Col>
            </Row>
            <ToastContainer/>
        </div>
